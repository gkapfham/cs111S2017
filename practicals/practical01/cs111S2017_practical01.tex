...
\begin{document}
\MYTITLE{Practical 1\\Assigned: Friday, January 20, 2017\\Due: Friday, January 27, 2017 at the start of class\\``Checkmark'' grade}
...
Now, the system will ask you to create a {\tt README} file. Deleting everything except the first line that is inside of
the text area, edit the description of your repository by adding in fun details about yourself and your goals and
reservations about this course. Once you have finished editing this file, you should save it and then enter a
descriptive message about the changes that you have just made and, finally, click the ``Commit'' button. Now, find and
click the ``three dot icon'' and then click the ``Clone'' button. Next, you should copy this entire command and, making
sure that you are first in the {\tt cs112S2017} directory, paste the command and then run it. At this point in the
assignment, you should see that you have downloaded files from the Bitbucket servers to your computer.
...
\url{http://gitimmersion.com/}.  After discussing them with the course instructor, a class member and a teaching
assistant, you should ensure that you have a basic understanding of the following Git commands: {\tt git status}, {\tt
git add}, {\tt git commit}, {\tt git push}, and {\tt git pull}.
